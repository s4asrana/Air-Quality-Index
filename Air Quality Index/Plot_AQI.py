...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 18 03:33:36 2022
...
def avg_data_2015():
    temp_i=0
    average=[]
    for chunk in pd.read_csv('Data/AQI/aqi2015.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
...
def avg_data_2016():
    temp_i=0
    average=[]
    for chunk in pd.read_csv('Data/AQI/aqi2016.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=chunk)
...
def avg_data_2017():
    temp_i=0
    average=[]
    for chunk in pd.read_csv('Data/AQI/aqi2017.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=chunk)
...
def avg_data_2018():
    temp_i=0
    average=[]
    for chunk in pd.read_csv('Data/AQI/aqi2018.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=chunk)
